...
/obj/effect/spawner/lootdrop/valuable_jewelry_spawner
	...
	) // The 'stat_' rings, alongside the unique psicross, are experimental additions. If they're showing up too much, don't be afraid to remove them or restrict them to a new lootdrop category.
