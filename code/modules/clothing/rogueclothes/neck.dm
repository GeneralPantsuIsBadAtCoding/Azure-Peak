...
/obj/item/clothing/neck/roguetown/psicross/naledi
	...
	desc = "A peculiar icon of worship from the golden dunes. Forming the three-progned Psydonite cross in a circular ring, this bracelet embodies the Naledian belief of Psydon's eternity."
