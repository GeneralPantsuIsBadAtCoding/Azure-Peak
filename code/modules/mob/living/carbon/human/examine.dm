...
//	var/t_him = p_them()
	...
	if(obscure_name)
		...
		if((HAS_TRAIT(src, TRAIT_OUTLANDER) && !HAS_TRAIT(user, TRAIT_OUTLANDER)) || (HAS_TRAIT(user, TRAIT_RACISMISBAD) && (src.dna.species.name == "Elf" || src.dna.species.name == "Dark Elf")))
