...
/datum/outfit/job/roguetown/bandit/iconoclast/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank(/datum/skill/combat/wrestling, 6, TRUE)  // Unarmed if we want to kick ass for the lord(you do, this is what you SHOULD DO!!) - One slot antag should not be worse than monks
